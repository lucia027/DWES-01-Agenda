...
public class CacheLruTests {
    ...
    public sealed class CasosPositivos {
        ...
        [Test]
        public void Add_VariosElementosValidos_GuardarElementos() {
            //Act
            _cache.Add(4, "cuatro");
            _cache.Add(5, "cinco");
            _cache.Add(6, "seis");
        ...
        [Test]
        public void DisplayStatus_CacheConElementos_NoLanzaExcepcion() {
            // Arrange
            _cache.Add(1, "uno");
            _cache.Add(2, "dos");

            // Act
            Action accion = () => _cache.DisplayStatus();
        ...
        [Test]
        public void DisplayStatus_CacheVacia_NoLanzaExcepcion() {
            // Act
            Action accion = () => _cache.DisplayStatus();
